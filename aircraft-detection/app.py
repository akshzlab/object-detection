...
model_path = Path("./notebooks/runs/detect/train/weights/best.pt")
...
def detect():
    ...
    try:
        ...
        if not is_video:
            ...
            result_image_pil.save(str(output_path), format="JPEG")
            ...
            results = model.predict(source=str(video_path), save=True, save_txt=True)

            processed_video_path = OUTPUT_DIR / "predict" / file.filename
